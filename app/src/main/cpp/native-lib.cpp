...
void ApplyMenuStyle(float density) {
  ...
  colors[ImGuiCol_ChildBg]                = ImVec4(0.11f, 0.13f, 0.16f, 0.40f);
  ...
  colors[ImGuiCol_FrameBgActive]          = ImVec4(0.23f, 0.28f, 0.38f, 1.00f);
  colors[ImGuiCol_TitleBg]                = ImVec4(0.06f, 0.07f, 0.09f, 1.00f);
  colors[ImGuiCol_TitleBgActive]          = ImVec4(0.08f, 0.09f, 0.12f, 1.00f);
  colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.06f, 0.07f, 0.09f, 0.50f);
